  ...
  productions =
    [| { lhs = Goal;
       ...
       { lhs = export
         ...
         rhs = RModule ConId
       { lhs = impdecl
         rhs = RImport RQualified ConId RAs ConId impspec
         rhs = RImport RQualified ConId RAs ConId
         rhs = RImport RQualified ConId impspec
         rhs = RImport RQualified ConId
         rhs = RImport ConId RAs ConId impspec
         rhs = RImport ConId RAs ConId
         rhs = RImport ConId impspec
         rhs = RImport ConId
       { lhs = impspec
         rhs = RHiding ( )
         rhs = RHiding ( , )
